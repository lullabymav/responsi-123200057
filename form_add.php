                ...
                <table>
                    <thead class="text-center text-light" style="background-color: midnightblue;">
                        <tr class="align-middle">
                            <th colspan="2" style="width: 500px;">Add Inventory Data</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="code" placeholder="Item code" style="width: 330px">
                            </td>
                        </tr>
                        <tr>
                            <td class="ps-3 " style="width: 150px;">Name of goods</td>
                            <td>
                                <input type="text" name="goods" placeholder="Name of goods" style="width: 330px">
                            </td>
                        </tr>
                        <tr>
                            <td class="p-3" style="width: 150px;">Amount</td>
                            <td>
                                <input type="text" name="amount" placeholder="Amount" style="width: 80px">
                            </td>
                        </tr>
                        <tr>
                            <td class="ps-3" style="width: 150px;">Unit</td>
                            <td>
                                <input type="text" name="unit" placeholder="Unit" style="width: 80px">
                            </td>
                        </tr>
                        <tr>
                            <td class="p-3" style="width: 150px;">Coming Date</td>
                            <td>
                                <input type="date" name="codate" class="py-1 ps-2">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="price" placeholder="Unit price" style="width: 330px">
                            </td>
                        </tr>
                    </tbody>
                </table>
                <div class="d-flex justify-content-center pt-2">                            
                    <button class="btn rounded-0 p-0 text-light px-4 py-1 mx-1" name="save" style="background-color: midnightblue;">Save</button>
